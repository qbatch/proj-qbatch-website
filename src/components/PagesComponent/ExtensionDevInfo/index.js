          ...
          <Row className='g-4'>
            <Col lg={6}>
             <div className='info-box'>
              <h3 className='text-h4'>Enterprise employees spend 75% of their work time on web browsing.</h3>
            ...
            <Col lg={6}>
             <div className='info-box'>
              <h3 className='text-h4'>The popularity of web browsing caused above 80% of cyberattacks in 2022 — becoming the world’s easiest attack vector.</h3>
