        ...
        <Row>
          <Col lg={6}>
            <div className='inner-wrapper'>
              ...
              <div className='inner-content'>
                <h4 className='text-h4'>Raise funds and skimp investments</h4>
          ...
          <Col lg={6}>
            <div className='inner-wrapper'>
              ...
              <div className='inner-content'>
                <h4 className='text-h4'>Get feedback and build your idea</h4>
          ...
          <Col lg={6}>
            <div className='inner-wrapper'>
              ...
              <div className='inner-content'>
                <h4 className='text-h4'>Check feasibility and scope</h4>
          ...
          <Col lg={6}>
            <div className='inner-wrapper'>
              ...
              <div className='inner-content'>
                <h4 className='text-h4'>Launch your app within 2 - 4 -months</h4>
          ...
          <Col lg={6}>
            <div className='inner-wrapper'>
              ...
              <div className='inner-content'>
                <h4 className='text-h4'>Build investors' trust</h4>
          ...
          <Col lg={6}>
            <div className='inner-wrapper'>
              ...
              <div className='inner-content'>
                <h4 className='text-h4'>Understand end users</h4>
