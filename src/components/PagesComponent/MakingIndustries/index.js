...
const Index =()=>{
    ...
    return (
      <MakingIndustriesWrapper>
        <Container>
          <h1 className="text-center color-primary">Happily Making Industries People-First</h1>
          <p className="text-center">
            You are the industry leader of today and tomorrow. Let us help you become unstoppable with versatile
            expertise and wide-spectrum technologies.
          </p>
