      ...
      <Container>
        <Row>
          <Col lg={6}>
            ...
            <p className="paragraph">We don’t just code or design, our efficiency is rooted in deeply 
            understanding your challenge. Our goal is to add technological value to your business and 
            future-proof your success. Therefore, we aim to be your software development partners!</p>
            <p className="paragraph">Team Qbatch has happily delivered powerful and painless 
            software services and solutions in HealthTech, EdTech, 3PL Warehousing, E-commerce
             Business Automation, FinTech, Food, Travel, and On-demand applications assuring lucrative
              results and optimal customer happiness — channeled through reliable industry knowledge and
               robust technology support.</p>
          </Col>
          <Col lg={6}>
      ...
      <Col lg={6} className="order-1 order-lg-2">
          ...
          <div className="content mission">
            ...
            fretting about financial and operational bottlenecks through intelligently designed
             and carefully deployed software solutions. </p>
          </div>
          </div>
        </Col>
