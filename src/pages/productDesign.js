...
import { productDesignlist , softwareProductData, developmentProcessData, productDesignFaq, productDesignData, cycleProductData} from "../constants";
...
const ProductDesign = () => {
  ...
  return (
    <Layout pageTitle="Product Design and Development">
      <HireCto list={productDesignlist} btnText=" Let’s fix it" groupClass="product-design" heading="Why do you need software product design
& development services?" paragraph="Have we identified your problem? >>"/>
      <TheySayWeSay/>
      ...
      />
      <PeopleFirst peopleFirstData={softwareProductData} paragraph="We as a software product development company can build these for you and more on demand" heading="Did we mention your next ‘Software Project’ below?" btnText="Got an Idea" wrapperClass="productDesignPage"/>
      <DevelopmentProcess boxesData={developmentProcessData}/>
      <WhyChooseQbatch/>
      <SeemToWork/>
      <ProvenWorkExperience heading="Featured Projects"  paragraph="Innovators from across the industry have trusted Qbatch to build high-impact products. "/>
      <Collaboration />
      <MarketplaceSellers heading="Need someone to lead your product development journey?" paragraph="First things first, our product experts own your idea and don’t sit until your product makes a stellar launch in the market." btnText="Get Your Product Expert" wrapperClass="productDesign"/>
...
export const Head = () => <SEO title="Product Design and Development | Qbatch" />
