          ...
          <Row className='g-4'>
            <Col lg={6}>
             <div className='info-box'>
              <p className='text-h4 inner-text'>Enterprise employees spend 75% of their work time on web browsing.</p>
            ...
            <Col lg={6}>
             <div className='info-box'>
              <p className='text-h4 inner-text'>The popularity of web browsing caused above 80% of cyberattacks in 2022 — becoming the world’s easiest attack vector.</p>
